...
export const Pay = () => {
  return (
    <div>
      <div className="flex justify-center items-center mb-10 bg-[#F3BA2F] h-20">
        <h1 className="text-black font-bold font-sans text-3xl underline decoration-white underline-offset-8 z-2">
          Account Options
        </h1>
      </div>
